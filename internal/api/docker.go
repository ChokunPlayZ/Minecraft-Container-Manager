...
// presence of the runtime image used to launch server containers. This lets
// the UI surface why a server might fail to start before the user tries to
// create or launch one.
