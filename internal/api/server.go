...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/servers/{id}/stats", s.requireAuth(s.wrapJSON(s.handleServerStats)))
	...
	s.mux.HandleFunc("GET /api/servers/{id}/whitelist", s.requireAuth(s.wrapJSON(s.handleListWhitelist)))
	...
	s.mux.HandleFunc("POST /api/servers/{id}/mods/sanitize-client-only", s.requireAuth(s.wrapJSON(s.handleSanitizeClientMods)))
